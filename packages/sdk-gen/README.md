...
> ⚠️ This project is **not affiliated with, endorsed by, or supported by Microsoft**.
...
* Modify or “fix” official OpenAPI specs

The CLI focuses strictly on:

> **discover → generate → package**
...
Después de ejemplos, las dos mejoras naturales son:

1) **Exports más limpios** en el SDK generado  
   (re-exportar APIs principales desde `index.ts`)
2) Un **wrapper opcional** (fuera del generator) para uso más cómodo

Pero eso ya es evolución, no requisito.
